...
{
  if (href == "/MAP579/courses/polymorphism/theme/dark.css")
  {
    return "dark";
  }
  else {
...
deck.initialize({
  ...
  menu: {
    themes: true,
    themes: [
      {name: 'dark', theme: '/MAP579/courses/polymorphism/theme/dark.css'},
      {name: 'light', theme: '/MAP579/courses/polymorphism/theme/light.css'}
    ],
