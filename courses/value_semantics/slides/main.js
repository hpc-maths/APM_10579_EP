...
{
  if (href == "/MAP579/courses/value_semantics/theme/dark.css")
  {
    return "dark";
  }
  else {
...
deck.initialize({
  ...
  menu: {
    themes: true,
    themes: [
      {name: 'dark', theme: '/MAP579/courses/value_semantics/theme/dark.css'},
      {name: 'light', theme: '/MAP579/courses/value_semantics/theme/light.css'}
    ],
